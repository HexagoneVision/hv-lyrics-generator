# Contributing to HV Lyrics Generator

🎉 **Welcome!**
We’re excited that you’re interested in contributing to **HV Lyrics Generator**. Contributions from the community make this project better for everyone — whether it’s fixing a bug, improving documentation, or adding new features.
...
1. **Fork** the repository
   ...
   ```bash
   git clone https://github.com/HexagoneVision/hv-lyrics-generator.git
   cd hv-lyrics-generator
   ```
...
- Join our [Discord server](https://discord.gg/QQTnW4pqyu) for ideas, feedback, and roadmap updates.
...
Your contributions make HV Lyrics Generator better.
